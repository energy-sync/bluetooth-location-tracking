...
var shownWarning = false; // XXX COMPAT WITH 0.8.3
...
Template.__define__ = function (name, renderFunc) {
  ...
  Template[name]._NOWARN_OLDSTYLE_HELPERS = true; // Now we want to show at least one warning so that people get serious about
